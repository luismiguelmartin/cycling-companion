...
('<USER_ID>', 'Salida club - Ritmo grupo', CURRENT_DATE - INTERVAL '7 days', 'outdoor', 7200, 80.0, 175, 140, 165, 84, 110, 6),
('<USER_ID>', 'Series cortas 10x1min', CURRENT_DATE - INTERVAL '9 days', 'indoor', 3000, 0, 230, 162, 182, 95, 65, 8),
('<USER_ID>', 'Rodaje suave', CURRENT_DATE - INTERVAL '10 days', 'outdoor', 4500, 48.0, 150, 130, 148, 80, 50, 4);

-- Semana -2
INSERT INTO activities (user_id, name, date, type, duration_seconds, distance_km, avg_power_watts, avg_hr_bpm, max_hr_bpm, avg_cadence_rpm, tss, rpe) VALUES
('<USER_ID>', 'Subida Puerto Alto - Test', CURRENT_DATE - INTERVAL '14 days', 'outdoor', 9000, 70.0, 200, 152, 170, 87, 150, 9),
('<USER_ID>', 'Sweet Spot 3x15min', CURRENT_DATE - INTERVAL '16 days', 'indoor', 4200, 0, 205, 150, 168, 90, 95, 7),
